...
#define TYPICAL_CAPACITY                   5000000

#define _TO_STR(x) #x
#define TO_STR(x) _TO_STR(x)
#if IS_ENABLED(CONFIG_XM_CHG_ANIMATION)
#define PROJECT_NAME                        n6
#define TYPICAL_CAPACITY_MAH                5000
#define INPUT_POWER_LIMIT                   67
#define INPUT_POWER_OVER_66W                66
...
#define FASTCHARGE_MIN_CURR                1500
...
struct charger_manager {
	...
	int qc3_mode;
	int normal_pps_adapter_temp_status;
	int input_suspend;
	int charger_region;
	bool qc_detected;
	...
	struct delayed_work normal_adapter_detect_plugin_lower_fcc_work;
	bool smart_ctrl_en;
	int charge_limit;
	int smart_batt;
	bool night_charging;
