...
__maybe_unused static int nu2115_enable_charge(struct nu2115 *chip, bool en)
{
	...
	nu2115_write_byte(chip, NU2115_REG_32, 0x70);//broaden VBUS ERRHI and VBUS ERRLO
	...
	nu2115_write_byte(chip, NU2115_REG_32, 0x50);//restore VBUS ERRHI and VBUS ERRLO
