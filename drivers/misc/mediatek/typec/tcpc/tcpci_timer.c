...
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE, 24, 27),
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE_30, 27, 32),
...
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_CK_NOT_SUPPORTED, 40, 49),
...
#if IS_ENABLED(USB_PD_VBUS_STABLE_TOUT)
...
#endif /* CONFIG_SUPPORT_SOUTHCHIP_PDPHY s*/
	mutex_unlock(&tcpc->timer_lock);
}
#endif /* CONFIG_USB_POWER_DELIVERY */
