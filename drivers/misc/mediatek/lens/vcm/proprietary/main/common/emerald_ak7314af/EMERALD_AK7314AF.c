...
#define AF_DRVNAME "EMERALD_AK7314AF_DRV"
...
/* initAF include driver initialization and active mode */
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		/* 0x00:active mode , 0x40:Standby mode , 0x20:Sleep mode */
		...
		//udelay(500);
			mdelay(5);
		//i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd, 2);
		/*n6 code for HQ-336394 by wangjie at 20231023 start*/
		//standby mode
		i4RetValue = i2c_smbus_write_byte_data(g_pstAF_I2Cclient, 0x02, 0x40);
		...
		mdelay(3);
		/*n6 code for HQ-336394 by wangjie at 20231023 end*/
...
/* ////////////////////////////////////////////////////////////// */
long EMERALD_AK7314AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int EMERALD_AK7314AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int EMERALD_AK7314AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int EMERALD_AK7314AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int EMERALD_AK7314AF_GetFileName(unsigned char *pFileName)
{
