...
#define AF_DRVNAME "EMERALD_GT9764BAVAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long EMERALD_GT9764BAVAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int EMERALD_GT9764BAVAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int EMERALD_GT9764BAVAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int EMERALD_GT9764BAVAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int EMERALD_GT9764BAVAF_GetFileName(unsigned char *pFileName)
{
