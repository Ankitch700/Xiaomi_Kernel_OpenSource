...
#include "ov08d10_ofilm_ultra_mipi_raw_Sensor.h"

#define PFX "OV08D10OFILMULTRA_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV08D10_OFILM_ULTRA_SENSOR_ID,
...
/*N6 code for HQ-309652 by HQ camera at 20230729 start*/
    .custom1 = {
		.pclk = 36000000,            //record different mode's pclk
		.linelength = 478,            //record different mode's linelength
		.framelength = 3072,            //record different mode's framelength
		.startx = 0,                    //record different mode's startx of grabwindow
		.starty = 0,                    //record different mode's starty of grabwindow
		.grabwindow_width = 1632,        //record different mode's width of grabwindow
		.grabwindow_height = 1224,        //record different mode's height of grabwindow
...
/*N6 code for HQ-309652 by HQ camera at 20230729 end*/
	...
	.custom2 = {
		.pclk = 36000000,            //record different mode's pclk
		.linelength = 460,            //record different mode's linelength
		.framelength = 3240,            //record different mode's framelength
		.startx = 0,                    //record different mode's startx of grabwindow
		.starty = 0,                    //record different mode's starty of grabwindow
		.grabwindow_width = 1632,        //record different mode's width of grabwindow
		.grabwindow_height = 1224,        //record different mode's height of grabwindow
...
/*N6 code for HQ-309652 by HQ camera at 20230729 start*/
	...
	.gain_type = 1,
/*N6 code for HQ-309652 by HQ camera at 20230729 end*/
/*N6 code for HQ-310620 by HQ camera at 20230804 start*/
	.max_frame_length = 0x7FFFEE,//max framelength by sensor register's limitation
/*N6 code for HQ-310620 by HQ camera at 20230804 end*/
...
/*N6 code for HQ-309652 by HQ camera at 20230729 end*/
	{  3264, 2448,  0, 0, 3264, 2448, 3264, 2448, 816, 612, 1632, 1224,  0, 0, 1632, 1224},  // custom2
};
...
static kal_uint32 return_sensor_id(void)
{
	...
	{
		pr_info("ov08d10 ofilm not match vendor id:0x%x\n",vendor_id);
		sensor_id = 0xFFFFFFFF;
	}
	pr_info("[%s] ov08d10 ofilm vendor_id: 0x%x, sensor_id: 0x%x\n", __func__, vendor_id, sensor_id);
/*N6 code for HQ-306077 by HQ camera at 20230713 end*/
	return sensor_id;
}
...
/*N6 code for HQ-310620 by HQ camera at 20230804 end*/
		...
		write_cmos_sensor(0xfd, 0x01);	//page1
		write_cmos_sensor(0x01, 0x01);	//freshSENSOR_DRVNAME_OV08D10_AAC_ULTRA_
			...
			kal_uint16 frame_length,kal_bool auto_extend_en)
{
	...
	LOG_INF("original shutter =%d, frame_length = %d", shutter, frame_length);
	spin_lock_irqsave(&imgsensor_drv_lock, flags);
	imgsensor.shutter = shutter;
	spin_unlock_irqrestore(&imgsensor_drv_lock, flags);
	spin_lock(&imgsensor_drv_lock);
...
static void custom2_setting(void)
{
	...
	write_cmos_sensor(0xa1, 0x6c);
	write_cmos_sensor(0xa2, 0x04);
	write_cmos_sensor(0xa3, 0xc8);
	write_cmos_sensor(0xa4, 0x03);
	write_cmos_sensor(0xa5, 0x38);
	write_cmos_sensor(0xa6, 0x06);
	write_cmos_sensor(0xa7, 0x60);
	write_cmos_sensor(0xfd, 0x05);
	write_cmos_sensor(0x04, 0x40);
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	/*N6R code for HQ-437837 by HQ camera at 20241224 start*/
    imgsensor.vblank_convert = 2504; //for 1632x1224
	/*N6R code for HQ-437837 by HQ camera at 20241224 end*/
...
UINT32 OV08D10_OFILM_ULTRA_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
