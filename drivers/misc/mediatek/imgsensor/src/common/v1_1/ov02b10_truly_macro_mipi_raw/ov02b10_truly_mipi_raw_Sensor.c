...
#include "ov02b10_truly_mipi_raw_Sensor.h"

#undef IMGSENSOR_I2C_1000K
#include "imgsensor_i2c.h"
#define IMGSENSOR_MODULE_ID_SUNNY       0x01
#define PFX "ov02b10_truly_camera_sensor"
...
static  imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_id = OV02B10_TRULY_MACRO_SENSOR_ID,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    LOG_INF("ov02b10_truly_macro get_vendor_id is: 0x%x\n", imgsensor_vendor_id);
    if(imgsensor_vendor_id != VENDOR_ID) {
        LOG_INF("ov02b10_truly_macro get_vendor_id error:0x%x\n", imgsensor_vendor_id);
...
UINT32 OV02B10_TRULY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
