...
#include "ov16a1q_aac_front_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV16A1Q_AAC_FRONT_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
/* N17 code for HQ-291083 by yangchangyun at 2023/05/30 end */
	...
	/*N6 code for  HQ-319123 by hudongjiao at 20230816 start*/
	.isp_driving_current = ISP_DRIVING_6MA, //mclk driving current
	/*N6 code for  HQ-319123 by hudongjiao at 20230816 end*/
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
 ...
 { 4656, 3496, 0, 0,   4656, 3496, 2328, 1748,   12, 226,  2304, 1296, 0, 0, 2304, 1296 },//custom3
};
...
static kal_uint32 return_sensor_id(void)
{
	...
	{
		sensor_id = OV16A1Q_AAC_FRONT_SENSOR_ID;	
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(ov16a1qaac_init_setting,
			sizeof(ov16a1qaac_init_setting) / sizeof(kal_uint16));
}	/*	sensor_init  */
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(ov16a1qaac_preview_setting,
		sizeof(ov16a1qaac_preview_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
static void capture_setting(void)
{
	...
	table_write_cmos_sensor(ov16a1qaac_capture_setting,
		sizeof(ov16a1qaac_capture_setting) / sizeof(kal_uint16));
}	/*	preview_setting  */
...
/* N17 code for HQ-291083 by yangchangyun at 2023/05/30 start */
	table_write_cmos_sensor(ov16a1qaac_normal_video_setting,
		sizeof(ov16a1qaac_normal_video_setting) / sizeof(kal_uint16));
/* N17 code for HQ-291083 by yangchangyun at 2023/05/30 end */
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(ov16a1qaac_hs_video_setting,
		sizeof(ov16a1qaac_hs_video_setting) / sizeof(kal_uint16));
}
...
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov16a1qaac_custom1_setting,
		sizeof(ov16a1qaac_custom1_setting) / sizeof(kal_uint16));
}

static void custom2_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov16a1qaac_custom2_setting,
		sizeof(ov16a1qaac_custom2_setting) / sizeof(kal_uint16));
}
static void custom3_setting(void)
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov16a1qaac_custom3_setting,
		sizeof(ov16a1qaac_custom3_setting) / sizeof(kal_uint16));
}
/*************************************************************************
* FUNCTION
*	get_imgsensor_id
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	LOG_INF("OV16A1QAAC get_imgsensor_id in\n");
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {		
		write_cmos_sensor(0x4012, 0x09);
		write_cmos_sensor(0x4E7C, 0x00);
		write_cmos_sensor(0x4E7F, 0x7a);
...
{
    LOG_INF("OV16A1Q_AAC_FRONT_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV16A1Q_AAC_FRONT_MIPI_RAW_SensorInit	*/
