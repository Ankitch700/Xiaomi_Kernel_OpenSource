...
#include "ov16a1q_ofilm_front_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV16A1Q_OFILM_FRONT_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 return_sensor_id(void)
{
	...
	printk("[%s] OV16A1Q_OFILM_FRONT sensor_id: 0x%x vendor_id: 0x%x sensorinfo_id: 0x%x", __func__, sensor_id, imgsensor.vendor_id, imgsensor_info.sensor_id);
	if ((VENDOR_ID == imgsensor.vendor_id) && (sensor_id == imgsensor_info.sensor_id))
	{
		sensor_id = OV16A1Q_OFILM_FRONT_SENSOR_ID;
		printk("[%s] OV16A1Q_OFILM_FRONT sensor_id: 0x%x", __func__, sensor_id);
	}
	else
		sensor_id = 0;
...
static void normal_video_setting(void)
{
	...
	table_write_cmos_sensor(ov16a1qofilm_normal_video_setting,
		sizeof(ov16a1qofilm_normal_video_setting) / sizeof(kal_uint16));
...
{
	LOG_INF("E\n");
	table_write_cmos_sensor(ov16a1qofilm_custom3_setting,
		sizeof(ov16a1qofilm_custom3_setting) / sizeof(kal_uint16));
}
/*************************************************************************
* FUNCTION
*	get_imgsensor_id
...
UINT32 OV16A1Q_OFILM_FRONT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    LOG_INF("OV16A1Q_OFILM_FRONT_MIPI_RAW_SensorInit in\n");
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}	/*	OV16A1Q_OFILM_FRONT_MIPI_RAW_SensorInit	*/
