...
#define SCREENOFF_TOUCH					0X28
#define GESTURE_WITHOUT_FINGERPRINT			0X20
...
#define TP_SELFTEST_RESULT_LEN				80
#define IIC_TEST_LEN					3
#define OPEN_TEST_LEN					4
#define SHORT_TEST_LEN					5
#define GTP_TP_SELFTEST_TMP_LEN				5
...
#define GOODIX_HDLE_MODE_CMD_LENGTH			5
...
struct goodix_ts_hw_ops {
	...
	/*N6 code for HQ-305061 by zhangzhijian5 at 2023/10/30 end*/
	/*N6 code for HQ-305055 by zhangzhijian5 at 2023/11/1 start*/
	int (*edge_mode_set)(struct goodix_ts_core *cd, int value);
	/*N6 code for HQ-305055 by zhangzhijian5 at 2023/11/1 end*/
	/*N6 code for HQ-346302 by huangshiquan at 2023/11/09 start*/
...
struct goodix_ts_core {
	...
	struct work_struct sleep_gesture_work;
