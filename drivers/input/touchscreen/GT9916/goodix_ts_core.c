...
/*N6 code for HQ-305054 by dingying at 2023/09/27 start*/
#include <linux/hqsysfs.h>
/*N6 code for HQ-305054 by dingying at 2023/09/27 end*/
...
enum TOUCH_SELECT {
    TOUCH_SELECT_FOCAL = 3,
    TOUCH_SELECT_GOODIX = 2,
};
...
extern int gsx_gesture_switch(struct input_dev *dev, unsigned int type,
...
static void goodix_set_gesture_work(struct work_struct *work)
{
	...
	ts_info("tybe is 0x%x", core_data->gesture_type);
...
static int goodix_touch_edge_mode_set(int value)
{
	...
	hw_ops = goodix_core_data->hw_ops;
	/*N6 code for HQ-342530 by zhangzhijian5 at 2023/11/2 start*/
	if (!hw_ops->edge_mode_set) {
		ts_err("edge_mode_set is NULL");
		return -EINVAL;
	}
	/*N6 code for HQ-342530 by zhangzhijian5 at 2023/11/2 end*/
	ret = hw_ops->edge_mode_set(goodix_core_data, value);
...
/*N6 code for HQ-301678 by dingying at 2023/09/19 start*/
	...
	ts_info("gpio_50 = %d, gpio_52 = %d\n", gpio_50, gpio_52);
	flag = gpio_50 << 1 | gpio_52;
	if (flag == TOUCH_SELECT_GOODIX) {
