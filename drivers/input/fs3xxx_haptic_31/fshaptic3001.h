...
/* N6 code for HQHW-5243 by p-dongfeiju1 at 2023/9/13 start */
enum fs3001_auto_brake_mode {
	FS3001_AUTO_BRAKE_DISABLE = 0,
	FS3001_AUTO_BRAKE_ENABLE = 1,
};
/* N6 code for HQHW-5243 by p-dongfeiju1 at 2023/9/13 end */
...
struct fs3001 {
	...
	unsigned char
		rtp_init; //in fs3001_rtp_work_routine, after memcpy(fs3001->rtp_container->data, rtp_file->data, rtp_file->size),rtp_init will be set to 1
...
extern int fs3001_parse_dt(struct device *dev, struct fs3001 *fs3001,
...
extern int fs3001_haptics_playback(struct input_dev *dev, int effect_id,
				   int val);
extern int fs3001_haptics_upload_effect(struct input_dev *dev,
