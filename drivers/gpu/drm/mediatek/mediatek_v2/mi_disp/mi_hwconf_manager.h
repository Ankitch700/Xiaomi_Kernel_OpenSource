...
extern int add_hw_monitor_info(char *component_name, char *mon_key,
			       char *mon_value);
extern int update_hw_monitor_info(char *component_name, char *mon_key,
				  char *mon_value);
...
static inline int add_hw_component_info(char *component_name, char *key,
					char *value)
{
	return 0;
}
...
static inline int add_hw_monitor_info(char *component_name, char *mon_key,
				      char *mon_value)
{
	return 0;
}
static inline int update_hw_monitor_info(char *component_name, char *mon_key,
					 char *mon_value)
{
	return 0;
}
