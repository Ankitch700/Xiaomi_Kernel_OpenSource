...
static int mi_cooler_brightness_clone_get_max_state(struct thermal_cooling_device *cdev,
					 unsigned long *state)
{
...
static int mi_cooler_brightness_clone_get_cur_state(struct thermal_cooling_device *cdev,
					 unsigned long *state)
{
...
static int mi_cooler_brightness_clone_set_cur_state(struct thermal_cooling_device *cdev,
					 unsigned long state)
{
	struct mtk_dsi *dsi = NULL;
